...
Expected: PASS (both tests). This locks an existing, verified property (0 violations across the demo corpora). If it FAILS, do NOT change the engine or the test — surface it: the invariant does not hold and the design assumption is wrong.
